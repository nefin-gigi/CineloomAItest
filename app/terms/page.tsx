  ...
  return (
    <main className="v3-marketing-page">
      ...
      <section className="v3-marketing-hero">
        ...
        <p>Users must own or control uploaded scripts, references, characters, voices, likenesses, and music inputs. Paid plans unlock commercial exports subject to provider terms and CineLoom policies.</p>
      </section>
