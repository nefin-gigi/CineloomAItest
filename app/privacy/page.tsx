  ...
  return (
    <main className="v3-marketing-page">
      ...
      <section className="v3-marketing-hero">
        ...
        <p>CineLoom should store private scripts and generated assets in protected storage, process account and billing data securely, and provide deletion controls before public launch.</p>
      </section>
